...
$resultt= mysqli_query($con,$sql);
 ...
 $s="select name,password from  `customers` where name='$name'";
...
elseif($num==1){
    ...
    <li><a href="#contact">CONTACT</a></li>
    <li><a href="profile.php?updateid='.$name.'">PROFILE</a></li>
    <li> <a href="logout.php">LOGOUT</a></li>
...
<div class="text-box">
    <h1>  
        <br><br>
        <spam class="hey"> Shayar</spam>'<spam class="hey">s</spam> cafe and <br>
        <spam class="spa">Resturant</spam><br>
    </h1>

    <p class="about">This is one of the finest resturant in the Area  we are specialed in making a home like food 
        <br>We have on goal to serve food as good as possible
        <br>Come and be apart of Shayar  ! thank you
    </p>
...
<div class="aphoto">
    ...
    <form action="cartform.php" method="POST">
         <button type="submit" name="submit"  class="but"> <a href="cartform.php?updateid='1'">Add to cart</a></button>
    </form>
...
<div class="bphoto">
    ...
    <p class="aaphoto"> Made with Italian Sauce, Chicken, and organice vegetables.</p>
    <form action="cartform.php" method="POST">
         <button type="submit" name="submit"  class="but"> <a href="cartform.php?updateid='2'">Add to cart</a></button>
    </form>
</div>
<div class="cphoto">
...
<div class="third">
    ...
    <div class="location">
        <h1>Shayar's Cafe & Resturant</h1>
        <img src="homeicon.png" alt="home" class="homeicon">
        <p>Near Marwari college Kishanganj</p>
        <img src="emailicon.png" alt="email" class="homeicon">
        <p>kashifqumar06@gmail.com</p>
...
<div class="content">
 <h2>About us</h2>
 <p><br>Adipisicing Eit.Cum LUsto Architecto 
